                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <Button 
                      ...
                      disabled={loading}
                      variant="google"
                      className="w-full h-12 flex items-center justify-center gap-3 transition-all font-bold text-sm"
                    >
                    ...
                    />
                    <p className="text-[10px] text-white/20 font-medium italic text-center px-4 uppercase tracking-widest leading-relaxed">
                      Don't have a passkey yet? Log in with email first, then register your device in Settings.
                    </p>
                  </div>
                </div>
              </motion.div>

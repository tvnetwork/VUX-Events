...
// Initialize Firestore with settings to resolve connectivity/protocol issues
// experimentalAutoDetectLongPolling: true helps in environments where WebSockets/QUIC are unstable
